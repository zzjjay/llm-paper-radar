...
> 📊 Scanned 50 papers → passed filter 0 (threshold ≥7) · 👤 0 from watched authors

> Table only — full summaries / why-selected / related methods live in the [detail page](digests/2026-05-13.md). Watched-author papers bypass the threshold and sit at the top. History: [INDEX.md](INDEX.md) · Config: [config.yaml](config.yaml) · Generated by [llm-paper-radar](https://github.com/zhaolin-amd/llm-paper-radar).

## 📚 Papers

_Nothing surfaced today (no threshold passes, no watchlist hits)._
