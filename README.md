...
# LLM Inference Optimization Daily · 2025-11-21

> 📅 Window: 2025-11-21 (UTC daily)
> 📊 Scanned 72 papers → passed filter 2 (threshold ≥7) · 👤 0 from watched authors

> Table only — full summaries / why-selected / related methods live in the [detail page](digests/2025-11-21.md). Watched-author papers bypass the threshold and sit at the top. History: [INDEX.md](INDEX.md) · Config: [config.yaml](config.yaml) · Generated by [llm-paper-radar](https://github.com/zhaolin-amd/llm-paper-radar).

## 📚 Papers

| # | Bucket | Paper | Authors | Date | Details |
|---|--------|-------|---------|------|---------|
| 1 | Diffusion compression | [SANA-Video: Efficient Video Generation with Block Linear Diffusion Transformer](https://arxiv.org/abs/2509.24695) 🔁 | Junsong Chen, Yuyang Zhao, Jincheng Yu et al. | 2025-09-29 | [📄](digests/2025-11-21.md#p-2509-24695) |
| 2 | Pruning / sparsity | [Nemotron Elastic: Towards Efficient Many-in-One Reasoning LLMs](https://arxiv.org/abs/2511.16664) | Ali Taghibakhshi, Sharath Turuvekere Sreenivas, Saurav Muralidharan et al. | 2025-11-20 | [📄](digests/2025-11-21.md#p-2511-16664) |
