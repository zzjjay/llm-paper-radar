...
> 📊 Scanned 32 papers → passed filter 2 (threshold ≥7) · 👤 2 from watched authors

> Tables only — full summaries / why-selected / related methods live in the [detail page](digests/2026-05-18.md). History: [INDEX.md](INDEX.md) · Config: [config.yaml](config.yaml) · Generated by [llm-paper-radar](https://github.com/zhaolin-amd/llm-paper-radar).

## 👤 Watched authors

| # | Paper | Authors | Date | Matched | Details |
|---|-------|---------|------|---------|---------|
| 1 | [SANA-WM: Efficient Minute-Scale World Modeling with Hybrid Linear Diffusion Transformer](https://arxiv.org/abs/2605.15178) | Haoyi Zhu, Haozhe Liu, Yuyang Zhao et al. | 2026-05-14 | Song Han | [📄](digests/2026-05-18.md#p-2605-15178) |
| 2 | [AnyFlow: Any-Step Video Diffusion Model with On-Policy Flow Map Distillation](https://arxiv.org/abs/2605.13724) 🔁 | Yuchao Gu, Guian Fang, Yuxin Jiang et al. | 2026-05-13 | Song Han | [📄](digests/2026-05-18.md#p-2605-13724) |

## 🔥 Highlighted papers

| # | Paper | Authors | Date | Bucket | Details |
|---|-------|---------|------|--------|---------|
| 1 | [Distilling Long-CoT Reasoning through Collaborative Step-wise Multi-Teacher Decoding](https://arxiv.org/abs/2605.02290) 🔁 | Taewon Yun, Jisu Shin, Jeonghwan Choi et al. | 2026-05-04 | Knowledge distillation | [📄](digests/2026-05-18.md#p-2605-02290) |
| 2 | [GQLA: Group-Query Latent Attention for Hardware-Adaptive Large Language Model Decoding](https://arxiv.org/abs/2605.15250) 🔁 | Fanxu Meng | 2026-05-14 | KV cache compression | [📄](digests/2026-05-18.md#p-2605-15250) |
