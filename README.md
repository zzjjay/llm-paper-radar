...
# LLM Inference Optimization Daily · 2026-05-15

> 📅 Window: 2026-05-15 (UTC daily)
> 📊 Scanned 296 papers → passed hard_gate 7 · 👤 0 from watched authors

> Table only — full summaries / why-selected / related methods live in the [detail page](digests/2026-05-15.md). Watched-author papers sit at the top. History: [INDEX.md](INDEX.md) · Config: [config.yaml](config.yaml) · Generated by [llm-paper-radar](https://github.com/zhaolin-amd/llm-paper-radar).

## 📚 Papers

| # | Bucket | Paper | Authors | Date | Why |
|---|--------|-------|---------|------|---------|
| 1 | PTQ (post-training quantization) | [XFP: Quality-Targeted Adaptive Codebook Quantization with Sparse Outlier Separation for LLM Inference](https://arxiv.org/abs/2605.14844) 🔁 | Thomas Witt | 2026-05-14 | [📄](digests/2026-05-15.md#p-2605-14844) |
| 2 | PTQ (post-training quantization) | [A Hardware-Aware, Per-Layer Methodology for Post-Training Quantization of Large Language Models](https://arxiv.org/abs/2605.14929) 🔁 | Earl Killian | 2026-05-14 | [📄](digests/2026-05-15.md#p-2605-14929) |
| 3 | KV cache compression | [Forcing-KV: Hybrid KV Cache Compression for Efficient Autoregressive Video Diffusion Models](https://arxiv.org/abs/2605.09681) 🔁 | Yicheng Ji, Zhizhou Zhong, Jun Zhang et al. | 2026-05-10 | [📄](digests/2026-05-15.md#p-2605-09681) |
| 4 | KV cache compression | [GQLA: Group-Query Latent Attention for Hardware-Adaptive Large Language Model Decoding](https://arxiv.org/abs/2605.15250) 🔁 | Fanxu Meng | 2026-05-14 | [📄](digests/2026-05-15.md#p-2605-15250) |
| 5 | Pruning & distillation | [BEAM: Binary Expert Activation Masking for Dynamic Routing in MoE](https://arxiv.org/abs/2605.14438) 🔁 | Juntong Wu, Jialiang Cheng, Qishen Yin et al. | 2026-05-14 | [📄](digests/2026-05-15.md#p-2605-14438) |
| 6 | Pruning & distillation | [Ghosted Layers: Unconstrained Activation Alignment for Recovering Layer-Pruned LLMs](https://arxiv.org/abs/2605.15491) 🔁 | Vincent-Daniel Yun, Junhyuk Jo, Sai Praneeth Karimireddy et al. | 2026-05-15 | [📄](digests/2026-05-15.md#p-2605-15491) |
| 7 | Pruning & distillation | [TAPIOCA: Why Task- Aware Pruning Improves OOD model Capability](https://arxiv.org/abs/2605.14738) 🔁 | Krish Sharma, Omar Naim, Soumadeep Saha et al. | 2026-05-14 | [📄](digests/2026-05-15.md#p-2605-14738) |
