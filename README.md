...
# LLM Inference Optimization Daily · 2026-04-20

> 📅 Window: 2026-04-20 (UTC daily)
> 📊 Scanned 78 papers → passed filter 2 (threshold ≥7) · 👤 0 from watched authors

> Table only — full summaries / why-selected / related methods live in the [detail page](digests/2026-04-20.md). Watched-author papers bypass the threshold and sit at the top. History: [INDEX.md](INDEX.md) · Config: [config.yaml](config.yaml) · Generated by [llm-paper-radar](https://github.com/zhaolin-amd/llm-paper-radar).

## 📚 Papers

| # | Bucket | Paper | Authors | Date | Details |
|---|--------|-------|---------|------|---------|
| 1 | Diffusion compression | [SANA-Video: Efficient Video Generation with Block Linear Diffusion Transformer](https://arxiv.org/abs/2509.24695) 🔁 | Junsong Chen, Yuyang Zhao, Jincheng Yu et al. | 2025-09-29 | [📄](digests/2026-04-20.md#p-2509-24695) |
| 2 | Speculative decoding | [DFlash: Block Diffusion for Flash Speculative Decoding](https://arxiv.org/abs/2602.06036) 🔁 | Jian Chen, Yesheng Liang, Zhijian Liu | 2026-02-05 | [📄](digests/2026-04-20.md#p-2602-06036) |

## 🔁 Revisited

- [SANA-Video: Efficient Video Generation with Block Linear Diffusion Transformer](https://arxiv.org/abs/2509.24695) — score 8
- [DFlash: Block Diffusion for Flash Speculative Decoding](https://arxiv.org/abs/2602.06036) — score 8
