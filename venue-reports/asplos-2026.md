...
Recovering quantization accuracy is treated as a hardware/kernel problem here, not just an algorithmic one — every method below pairs a numeric trick with a custom datapath, which is exactly the co-design step MLSys's software-only quant papers skip (and can't do, running on someone else's GPU). [M2XFP](https://doi.org/10.1145/3779212.3790185) adds minimal metadata to microscaling MXFP4 to recover accuracy (−70.6% accuracy loss vs MXFP4, beats NVFP4) via algorithm-hardware co-design; [Tilus](https://doi.org/10.1145/3760250.3762219) (NVIDIA) is a tile-level GPGPU DSL for arbitrary 1–8-bit types, beating Triton/Marlin low-precision kernels; [Mugi](https://doi.org/10.1145/3779212.3790189) builds value-level-parallelism datapaths for low-precision LLM GEMM *and* nonlinear ops (softmax); [ZipServ](https://doi.org/10.1145/3779212.3790250) does lossless weight compression with a fused decompress-into-Tensor-Core GEMM (−30% model size, 1.22× e2e).

## 6. The ASPLOS signature: algorithm–hardware co-design and beyond-NVIDIA heterogeneity

Where MLSys's heterogeneity was mostly "AMD + new NVIDIA generations," ASPLOS treats the memory wall itself as license to change the hardware, not just the kernel — the substrate diversity below is the point, not a side detail. This is the distinguishing thread: ReRAM PIM ([REPA](https://doi.org/10.1145/3779212.3790212)), HBM-PIM ([STARC](https://doi.org/10.1145/3779212.3790226)), wafer-scale SRAM CIM ([Ouroboros](https://doi.org/10.1145/3779212.3790197)), near-storage SmartSSD ([HILOS](https://doi.org/10.1145/3779212.3790119)), FPGA ([DFVG](https://doi.org/10.1145/3779212.3790153)), custom MoE/low-precision datapaths ([EARTH](https://doi.org/10.1145/3779212.3790155), [Mugi](https://doi.org/10.1145/3779212.3790189)), Ascend NPUs ([XY-Serve](https://doi.org/10.1145/3760250.3762228)), and AMD GPUs — [MSCCL++](https://doi.org/10.1145/3779212.3790188) (Microsoft), a portable GPU-communication layer for AI inference, is in production on Azure and adopted by AMD's RCCL.
